...
public class OverviewStatsBuilder {
    ...
    // This is a copy of Stats#calculateDue that is more similar to the original desktop version.
    // It allows us to easily fetch the values required for the summary.
    // NOTE: this version calculates more accurate results but the method that interprets the
    // results is not compatible and is not trivial to change. In the future, this version
    // should replace it.
